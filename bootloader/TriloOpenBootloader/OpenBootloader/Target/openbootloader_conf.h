...
/* -------------------------------- Device ID ------------------------------- */
// Found in section 59.12.4 of the reference manual
...
#define DEVICE_ID_LSB                     0x78		  /* LSB byte of device ID */
...
#define UUID_SIZE                         12U
#define UUID_START_ADDRESS                UID_BASE
#define UUID_END_ADDRESS                  (UUID_START_ADDRESS + UUID_SIZE)

#define RAM_SIZE                          (272U * 1024U)                  /* Size of RAM 272 kByte */
...
#define UUID_AREA                         0x7U  /* UUID bytes area */
